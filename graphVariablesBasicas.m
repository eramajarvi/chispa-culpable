function graphVariablesBasicas(X1, Y1, X2, Y2, Y3)
%CREATEFIGURE(X1, Y1, X2, Y2, Y3)
%  X1:  vector of x data
%  Y1:  vector of y data
%  X2:  vector of x data
%  Y2:  vector of y data
...
% Create plot
plot(X1,Y1,'Parent',subplot1,'LineWidth',0.7,...
...
% Create plot
plot(X2,Y2,'Parent',subplot2,'LineWidth',0.7,'Color',[0 0 0]);
